...
def test_update_sql_injection(base_url: str = "https://127.0.0.1:8000",
    ...
    injection_payloads = get_update_injection_payloads()
...
def get_update_injection_payloads():
    """Get SQL injection payloads for update endpoint"""
    return [
        {
            "name": "Update value injection - OR",
            "description": "Update value injection - OR",
            "table": "students",
            "key": {"StuID": 100},
            "updateValues": {
        ...
        },
        {
            ...
            "description": "Update value injection - Comment",
            "table": "students",
            "key": {"StuID": 100},
            "updateValues": {
                "email": "test@test.com' --"
        ...
        },
        {
            ...
            "description": "Update value injection - Stacked",
            "table": "students",
            "key": {"StuID": 100},
            "updateValues": {
        ...
        },
        {
            ...
            "description": "Primary key injection",
            "table": "students",
...
def run_update_injection_tests():
    """Run update injection tests with formatted output"""
    print("=" * 60)
    print("SQL Injection Test - Update Endpoint")
    print("=" * 60)
    ...
    injection_payloads = get_update_injection_payloads()
    print(f"\n[Attack Test] Starting SQL injection tests on /data/update endpoint")
    print(f"[Attack Test] Testing {len(injection_payloads)} injection payloads...\n")
    
    results = test_update_sql_injection(auth_token=auth_token)
